...
export PATH="/usr/local/go/bin:/Users/andre/.cargo/bin:/home/andre/.local/bin:./node_modules/.bin:/usr/local/opt:/usr/local/sbin:/usr/local/opt/postgresql@11/bin:$PATH:../node_modules/.bin"
